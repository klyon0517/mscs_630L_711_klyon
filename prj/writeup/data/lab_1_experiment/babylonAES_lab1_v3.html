<!--  BabylonAES
      ...
      * Filename: babylonAES_lab1_v3.php
      * Author: Kerry Lyon
      * Created: March 20, 2022

      * Refinement of lab 1 position animation test.
      * Planes animate with an offset.
    ...
    <script>
      ...
      const createScene =  () => {
        ...
        for (var i = 0; i < plainText.length; i++) {
          ...
          scene.beginDirectAnimation(plane, [ySlide], 0, (2 + endFrame) * frameRate, false);
